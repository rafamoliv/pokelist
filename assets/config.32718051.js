...
import { m as mapValues_1, c as commonjsGlobal, a as combineParameters, g as getDefaultExportFromCjs, d as dedent, b as getAugmentedNamespace, _ as _baseGetTag, i as isArray_1, e as isObjectLike_1, f as isPlainObject_1, h as isFunction_1, j as addons, u as useEffect, l as logger, k as browser } from "./iframe.16f10e94.js";
import "./es.map.constructor.edb80200.js";
import { p as propTypes } from "./index.0458719a.js";
import { R as React__default, r as react, j as jsx$1 } from "./jsx-runtime.1846cd15.js";
import { s as str } from "./string.c8a6e64c.js";
var convertSig$1 = /* @__PURE__ */ __name(function convertSig(type) {
  switch (type.type) {
    case "function":
      return {
        name: "function"
    ...
    case "object":
      ...
      type.signature.properties.forEach(function(prop) {
        values[prop.key] = convert$3(prop.value);
      });
      return {
        name: "object",
        value: values
...
var convert$3 = /* @__PURE__ */ __name(function convert(type) {
  var name2 = type.name, raw = type.raw;
  var base2 = {};
  ...
  switch (type.name) {
    ...
    case "signature":
      return Object.assign({}, base2, convertSig$1(type));
    case "union":
    case "intersection":
      return Object.assign({}, base2, {
        name: name2,
...
var isLiteral = /* @__PURE__ */ __name(function isLiteral2(type) {
  return type.name === "literal";
}, "isLiteral");
var toEnumOption = /* @__PURE__ */ __name(function toEnumOption2(element) {
  return element.value.replace(/['|"]/g, "");
}, "toEnumOption");
var convertSig2 = /* @__PURE__ */ __name(function convertSig3(type) {
  switch (type.type) {
    case "function":
      return {
        name: "function"
    ...
    case "object":
      var values = {};
      type.signature.properties.forEach(function(prop) {
        values[prop.key] = convert$2(prop.value);
      });
      return {
        name: "object",
        value: values
...
var convert$2 = /* @__PURE__ */ __name(function convert2(type) {
  var name2 = type.name, raw = type.raw;
  var base2 = {};
  if (typeof raw !== "undefined")
    base2.raw = raw;
  switch (type.name) {
    ...
    case "signature":
      return Object.assign({}, base2, convertSig2(type));
    case "union":
...
var QUOTE_REGEX = /^['"]|['"]$/g;
var trimQuotes = /* @__PURE__ */ __name(function trimQuotes2(str2) {
  return str2.replace(QUOTE_REGEX, "");
}, "trimQuotes");
var includesQuotes = /* @__PURE__ */ __name(function includesQuotes2(str2) {
  return QUOTE_REGEX.test(str2);
}, "includesQuotes");
var SIGNATURE_REGEXP = /^\(.*\) => /;
var convert$1 = /* @__PURE__ */ __name(function convert3(type) {
  var name2 = type.name, raw = type.raw, computed = type.computed, value = type.value;
  var base2 = {};
  if (typeof raw !== "undefined")
    base2.raw = raw;
  switch (name2) {
    case "enum": {
      var _values = computed ? value : value.map(function(v2) {
        var trimmedValue = trimQuotes(v2.value);
        return includesQuotes(v2.value) || Number.isNaN(Number(trimmedValue)) ? trimmedValue : Number(trimmedValue);
      });
      return Object.assign({}, base2, {
        name: name2,
        value: _values
    ...
    case "shape":
    case "exact":
      var values = mapValues_1(value, function(field) {
        return convert3(field);
      });
      return Object.assign({}, base2, {
        name: "object",
        value: values
    ...
    case "elementType":
    default: {
      if ((name2 === null || name2 === void 0 ? void 0 : name2.indexOf("|")) > 0) {
        try {
          var literalValues = name2.split("|").map(function(v2) {
      ...
      var otherVal = value ? "".concat(name2, "(").concat(value, ")") : name2;
      var otherName = SIGNATURE_REGEXP.test(name2) ? "function" : "other";
      return Object.assign({}, base2, {
        name: otherName,
        value: otherVal
      });
...
var convert4 = /* @__PURE__ */ __name(function convert5(docgenInfo) {
  var type = docgenInfo.type, tsType = docgenInfo.tsType, flowType = docgenInfo.flowType;
  if (type != null)
    return convert$1(type);
  if (tsType != null)
    return convert$3(tsType);
  if (flowType != null)
    return convert$2(flowType);
  return null;
}, "convert");
var TypeSystem;
...
(function() {
  ...
  __name(isDecimalDigit2, "isDecimalDigit");
  ...
  __name(isOctalDigit2, "isOctalDigit");
...
var typed = {};
var utility = {};
const name$1 = "doctrine";
const description$1 = "JSDoc parser";
const homepage$1 = "https://github.com/eslint/doctrine";
const main$1 = "lib/doctrine.js";
...
const repository$1 = "eslint/doctrine";
...
var util$2 = {};
var isBufferBrowser = /* @__PURE__ */ __name(function isBuffer(arg) {
...
function isBuffer2(b2) {
  if (commonjsGlobal.Buffer && typeof commonjsGlobal.Buffer.isBuffer === "function") {
    return commonjsGlobal.Buffer.isBuffer(b2);
  }
...
assert.AssertionError = /* @__PURE__ */ __name(function AssertionError(options) {
...
function objEquiv(a, b2, strict2, actualVisitedObjects) {
  if (a === null || a === void 0 || b2 === null || b2 === void 0)
    return false;
  if (util$1.isPrimitive(a) || util$1.isPrimitive(b2))
    return a === b2;
...
(function() {
  ...
  __name(DoctrineError, "DoctrineError");
  DoctrineError.prototype = function() {
    var Middle = /* @__PURE__ */ __name(function() {
    }, "Middle");
  ...
  utility.assert = assert$1.exports;
})();
(function() {
  var Syntax, Token3, source, length, index, previous, token, value, esutils, utility$1, rangeOffset, addRange;
  esutils = utils;
  utility$1 = utility;
  Syntax = {
  ...
  __name(maybeAddRange, "maybeAddRange");
  function advance2() {
  ...
  __name(scanHexEscape, "scanHexEscape");
  function scanString() {
            ...
            default:
              if (esutils.code.isOctalDigit(ch.charCodeAt(0))) {
                ...
                if (index < length && esutils.code.isOctalDigit(source.charCodeAt(index))) {
                  code2 = code2 * 8 + "01234567".indexOf(advance2());
  ...
  __name(scanTypeName, "scanTypeName");
  function next() {
    var ch;
    previous = index;
  ...
  function parseUnionType() {
    ...
    consume(Token3.LPAREN, "UnionType should start with (");
    elements = [];
    ...
    consume(Token3.RPAREN, "UnionType should end with )");
    return maybeAddRange({
      type: Syntax.UnionType,
      elements
    }, [startIndex, previous]);
  }
  __name(parseUnionType, "parseUnionType");
  function parseArrayType() {
    var elements, startIndex = index - 1, restStartIndex;
    consume(Token3.LBRACK, "ArrayType should start with [");
    elements = [];
    while (token !== Token3.RBRACK) {
      if (token === Token3.REST) {
      ...
      if (token !== Token3.RBRACK) {
        expect(Token3.COMMA);
      }
    }
    expect(Token3.RBRACK);
    return maybeAddRange({
  ...
  function parseFieldName() {
    var v2 = value;
    if (token === Token3.NAME || token === Token3.STRING) {
      next();
      return v2;
    }
    if (token === Token3.NUMBER) {
      consume(Token3.NUMBER);
      return String(v2);
    }
    utility$1.throwError("unexpected token");
  }
  __name(parseFieldName, "parseFieldName");
  function parseFieldType() {
    var key, rangeStart = previous;
    key = parseFieldName();
    if (token === Token3.COLON) {
      consume(Token3.COLON);
      return maybeAddRange({
  ...
  __name(parseFieldType, "parseFieldType");
  function parseRecordType() {
    var fields, rangeStart = index - 1, rangeEnd;
    consume(Token3.LBRACE, "RecordType should start with {");
    fields = [];
    if (token === Token3.COMMA) {
      consume(Token3.COMMA);
    } else {
      while (token !== Token3.RBRACE) {
        fields.push(parseFieldType());
        if (token !== Token3.RBRACE) {
          expect(Token3.COMMA);
        }
      }
    }
    rangeEnd = index;
    expect(Token3.RBRACE);
    return maybeAddRange({
      type: Syntax.RecordType,
      fields
    }, [rangeStart, rangeEnd]);
  }
  __name(parseRecordType, "parseRecordType");
  function parseNameExpression() {
    var name2 = value, rangeStart = index - name2.length;
    expect(Token3.NAME);
    if (token === Token3.COLON && (name2 === "module" || name2 === "external" || name2 === "event")) {
      consume(Token3.COLON);
      name2 += ":" + value;
      expect(Token3.NAME);
    }
  ...
  __name(parseNameExpression, "parseNameExpression");
  function parseTypeExpressionList() {
    var elements = [];
    elements.push(parseTop());
    while (token === Token3.COMMA) {
      consume(Token3.COMMA);
      elements.push(parseTop());
    }
    return elements;
  }
  __name(parseTypeExpressionList, "parseTypeExpressionList");
  function parseTypeName() {
    var expr, applications, startIndex = index - value.length;
    expr = parseNameExpression();
    if (token === Token3.DOT_LT || token === Token3.LT) {
      next();
  ...
  __name(parseTypeName, "parseTypeName");
  function parseResultType() {
    consume(Token3.COLON, "ResultType should start with :");
    if (token === Token3.NAME && value === "void") {
      consume(Token3.NAME);
      return {
  ...
  __name(parseResultType, "parseResultType");
  function parseParametersType() {
    var params = [], optionalSequence = false, expr, rest = false, startIndex, restStartIndex = index - 3, nameStartIndex;
    while (token !== Token3.RPAREN) {
      if (token === Token3.REST) {
        consume(Token3.REST);
        rest = true;
      }
      ...
      if (expr.type === Syntax.NameExpression && token === Token3.COLON) {
      ...
      if (token === Token3.EQUAL) {
        consume(Token3.EQUAL);
        expr = maybeAddRange({
  ...
  __name(parseParametersType, "parseParametersType");
  function parseFunctionType() {
    var isNew, thisBinding, params, result, fnType, startIndex = index - value.length;
    utility$1.assert(token === Token3.NAME && value === "function", "FunctionType should start with 'function'");
    consume(Token3.NAME);
    expect(Token3.LPAREN);
    isNew = false;
    params = [];
    thisBinding = null;
    if (token !== Token3.RPAREN) {
      if (token === Token3.NAME && (value === "this" || value === "new")) {
        isNew = value === "new";
        consume(Token3.NAME);
        expect(Token3.COLON);
  ...
  __name(parseFunctionType, "parseFunctionType");
  ...
  __name(parseBasicTypeExpression, "parseBasicTypeExpression");
  function parseTypeExpression() {
    var expr, rangeStart;
    if (token === Token3.QUESTION) {
      rangeStart = index - 1;
      consume(Token3.QUESTION);
      if (token === Token3.COMMA || token === Token3.EQUAL || token === Token3.RBRACE || token === Token3.RPAREN || token === Token3.PIPE || token === Token3.EOF || token === Token3.RBRACK || token === Token3.GT) {
        return maybeAddRange({
    ...
    if (token === Token3.LBRACK) {
      consume(Token3.LBRACK);
      expect(Token3.RBRACK, "expected an array-style type declaration (" + value + "[])");
      return maybeAddRange({
        type: Syntax.TypeApplication,
  ...
  __name(parseTypeExpression, "parseTypeExpression");
  function parseTop() {
    var expr, elements;
    expr = parseTypeExpression();
    if (token !== Token3.PIPE) {
      return expr;
    }
    elements = [expr];
    consume(Token3.PIPE);
  ...
  __name(parseTopParamType, "parseTopParamType");
  ...
  __name(stringifyImpl, "stringifyImpl");
...
(function(exports) {
  (function() {
    ...
    __name(sliceSource, "sliceSource");
    hasOwnProperty2 = function() {
      var func = Object.prototype.hasOwnProperty;
      return /* @__PURE__ */ __name(function hasOwnProperty3(obj, name2) {
    ...
    __name(isParamTitle, "isParamTitle");
    function isReturnTitle(title) {
      return title === "return" || title === "returns";
    }
    __name(isReturnTitle, "isReturnTitle");
    ...
    __name(isNameParameterRequired, "isNameParameterRequired");
    function isAllowedName(title) {
      return isNameParameterRequired(title) || title === "const" || title === "constant";
    }
    __name(isAllowedName, "isAllowedName");
    function isAllowedNested(title) {
      return isProperty(title) || isParamTitle(title);
    }
    __name(isAllowedNested, "isAllowedNested");
    function isAllowedOptional(title) {
      return isProperty(title) || isParamTitle(title);
    }
    __name(isAllowedOptional, "isAllowedOptional");
    ...
    __name(isTypeParameterRequired, "isTypeParameterRequired");
    ...
    __name(isAllowedType, "isAllowedType");
    var WHITESPACE = "[ \\f\\t\\v\\u00a0\\u1680\\u180e\\u2000-\\u200a\\u202f\\u205f\\u3000\\ufeff]";
    ...
    __name(convertUnwrappedCommentIndex, "convertUnwrappedCommentIndex");
    (function(exports2) {
      var Rules, index, lineNumber, length, source, originalSource, recoverable, sloppy, strict2;
      function advance2() {
      ...
      __name(seekContent, "seekContent");
      ...
      function skipWhiteSpace2(last) {
        while (index < last && (esutils.code.isWhiteSpace(source.charCodeAt(index)) || esutils.code.isLineTerminator(source.charCodeAt(index)))) {
          advance2();
        }
      }
      __name(skipWhiteSpace2, "skipWhiteSpace");
      function parseName(last, allowBrackets, allowNestedParams) {
        var name2 = "", useBrackets, insideString;
        skipWhiteSpace2(last);
        if (index >= last) {
          return null;
        }
      ...
      __name(convertIndex, "convertIndex");
      ...
      __name(TagParser, "TagParser");
      TagParser.prototype.addError = /* @__PURE__ */ __name(function addError(errorText) {
      ...
      TagParser.prototype.parseDescription = /* @__PURE__ */ __name(function parseDescription() {
      ...
      TagParser.prototype.parseCaption = /* @__PURE__ */ __name(function parseDescription() {
        var description2 = sliceSource(source, index, this._last).trim();
      ...
      TagParser.prototype.parseKind = /* @__PURE__ */ __name(function parseKind() {
        var kind, kinds;
        kinds = {
          "class": true,
          "constant": true,
      ...
      TagParser.prototype.parseAccess = /* @__PURE__ */ __name(function parseAccess() {
        var access;
      ...
      TagParser.prototype.parseThis = /* @__PURE__ */ __name(function parseThis() {
      ...
      TagParser.prototype.parseVariation = /* @__PURE__ */ __name(function parseVariation() {
        var variation, text;
      ...
      TagParser.prototype.epilogue = /* @__PURE__ */ __name(function epilogue() {
        var description2;
      ...
      TagParser.prototype.parse = /* @__PURE__ */ __name(function parse5() {
      ...
      function scanJSDocDescription(preserveWhitespace) {
        ...
        while (index < length) {
          ...
          description2 += advance2();
        }
        return preserveWhitespace ? description2 : description2.trim();
      }
      __name(scanJSDocDescription, "scanJSDocDescription");
      function parse4(comment, options) {
...
function parse$2(content, tags) {
  var ast2;
  try {
    ast2 = doctrine.parse(content, {
      tags,
      sloppy: true
    });
  } catch (e2) {
...
var parseJsDoc = /* @__PURE__ */ __name(function parseJsDoc2(value) {
  ...
  var jsDocAst = parse$2(value, options.tags);
...
function extractJsDocTags(ast2) {
  ...
  for (var i = 0; i < ast2.tags.length; i += 1) {
    var tag = ast2.tags[i];
    if (tag.title === "ignore") {
...
function extractParam(tag) {
  ...
  if (paramName != null && paramName !== "null-null") {
    return {
      ...
      getPrettyName: /* @__PURE__ */ __name(function getPrettyName() {
        if (paramName.includes("null")) {
          return paramName.replace("-null", "").replace(".null", "");
        }
        return tag.name;
      }, "getPrettyName"),
      getTypeName: /* @__PURE__ */ __name(function getTypeName() {
...
function generateUnionElement(_ref) {
  var name2 = _ref.name, value = _ref.value, elements = _ref.elements, raw = _ref.raw;
  if (value != null) {
    return value;
  }
  if (elements != null) {
...
function generateUnion$1(_ref2) {
  var name2 = _ref2.name, raw = _ref2.raw, elements = _ref2.elements;
  if (elements != null) {
  ...
  return createSummaryValue(name2);
}
__name(generateUnion$1, "generateUnion$1");
function generateFuncSignature$1(_ref3) {
...
__name(generateFuncSignature$1, "generateFuncSignature$1");
...
function generateSignature(flowType) {
  ...
  return type === "object" ? generateObjectSignature(flowType) : generateFuncSignature$1(flowType);
}
__name(generateSignature, "generateSignature");
function generateDefault(_ref5) {
  var name2 = _ref5.name, raw = _ref5.raw;
  if (raw != null) {
    return !isTooLongForTypeSummary(raw) ? createSummaryValue(raw) : createSummaryValue(name2, raw);
  }
  return createSummaryValue(name2);
}
__name(generateDefault, "generateDefault");
function createType$3(type) {
  if (type == null) {
    return null;
  }
  switch (type.name) {
    case FlowTypesType.UNION:
      return generateUnion$1(type);
...
__name(createType$3, "createType$3");
function createDefaultValue$3(defaultValue, type) {
...
__name(createDefaultValue$3, "createDefaultValue$3");
var createFlowPropDef = /* @__PURE__ */ __name(function createFlowPropDef2(propName, docgenInfo) {
  var flowType = docgenInfo.flowType, description2 = docgenInfo.description, required = docgenInfo.required, defaultValue = docgenInfo.defaultValue;
  return {
    name: propName,
    type: createType$3(flowType),
    required,
    description: description2,
    defaultValue: createDefaultValue$3(defaultValue, flowType)
  };
}, "createFlowPropDef");
function createType$2(_ref) {
...
__name(createType$2, "createType$2");
function createDefaultValue$2(_ref) {
...
__name(createDefaultValue$2, "createDefaultValue$2");
var createTsPropDef = /* @__PURE__ */ __name(function createTsPropDef2(propName, docgenInfo) {
  var description2 = docgenInfo.description, required = docgenInfo.required;
  return {
    name: propName,
    type: createType$2(docgenInfo),
    required,
    description: description2,
    defaultValue: createDefaultValue$2(docgenInfo)
  };
}, "createTsPropDef");
function createType$1(type) {
  return type != null ? createSummaryValue(type.name) : null;
}
__name(createType$1, "createType$1");
...
function createDefaultValue$1(defaultValue, type) {
  if (defaultValue != null) {
    var value = defaultValue.value;
    if (!isDefaultValueBlacklisted(value)) {
...
__name(createDefaultValue$1, "createDefaultValue$1");
function createBasicPropDef(name2, type, docgenInfo) {
  var description2 = docgenInfo.description, required = docgenInfo.required, defaultValue = docgenInfo.defaultValue;
  return {
    name: name2,
    type: createType$1(type),
    required,
    description: description2,
    defaultValue: createDefaultValue$1(defaultValue, type)
  };
}
__name(createBasicPropDef, "createBasicPropDef");
function applyJsDocResult(propDef, jsDocParsingResult) {
  if (jsDocParsingResult.includesJsDoc) {
    var description2 = jsDocParsingResult.description, extractedTags = jsDocParsingResult.extractedTags;
...
var javaScriptFactory = /* @__PURE__ */ __name(function javaScriptFactory2(propName, docgenInfo, jsDocParsingResult) {
  var propDef = createBasicPropDef(propName, docgenInfo.type, docgenInfo);
  propDef.sbType = convert4(docgenInfo);
  return applyJsDocResult(propDef, jsDocParsingResult);
}, "javaScriptFactory");
var tsFactory = /* @__PURE__ */ __name(function tsFactory2(propName, docgenInfo, jsDocParsingResult) {
  var propDef = createTsPropDef(propName, docgenInfo);
  propDef.sbType = convert4(docgenInfo);
  return applyJsDocResult(propDef, jsDocParsingResult);
}, "tsFactory");
var flowFactory = /* @__PURE__ */ __name(function flowFactory2(propName, docgenInfo, jsDocParsingResult) {
  var propDef = createFlowPropDef(propName, docgenInfo);
  propDef.sbType = convert4(docgenInfo);
  return applyJsDocResult(propDef, jsDocParsingResult);
}, "flowFactory");
var unknownFactory = /* @__PURE__ */ __name(function unknownFactory2(propName, docgenInfo, jsDocParsingResult) {
  var propDef = createBasicPropDef(propName, {
    name: "unknown"
  }, docgenInfo);
  return applyJsDocResult(propDef, jsDocParsingResult);
}, "unknownFactory");
var getPropDefFactory = /* @__PURE__ */ __name(function getPropDefFactory2(typeSystem) {
  switch (typeSystem) {
...
var getTypeSystem = /* @__PURE__ */ __name(function getTypeSystem2(docgenInfo) {
...
var extractComponentSectionArray = /* @__PURE__ */ __name(function extractComponentSectionArray2(docgenSection) {
...
var extractComponentSectionObject = /* @__PURE__ */ __name(function extractComponentSectionObject2(docgenSection) {
...
var extractComponentProps = /* @__PURE__ */ __name(function extractComponentProps2(component, section) {
...
var enhanceArgTypes = /* @__PURE__ */ __name(function enhanceArgTypes2(context) {
...
const htmlTags = /* @__PURE__ */ getDefaultExportFromCjs(htmlTags$1.exports);
...
(function(exports) {
  (/* @__PURE__ */ __name(function clone(exports2) {
    ...
    Controller.prototype.current = /* @__PURE__ */ __name(function current2() {
...
__name(requireBase64Vlq, "requireBase64Vlq");
var util = {};
var hasRequiredUtil;
...
__name(requireArraySet, "requireArraySet");
var mappingList = {};
...
__name(requireMappingList, "requireMappingList");
...
__name(requireSourceMapGenerator, "requireSourceMapGenerator");
...
__name(requireBinarySearch, "requireBinarySearch");
var quickSort = {};
...
__name(requireQuickSort, "requireQuickSort");
...
__name(requireSourceMapConsumer, "requireSourceMapConsumer");
var sourceNode = {};
...
__name(requireSourceNode, "requireSourceNode");
...
__name(requireSourceMap, "requireSourceMap");
...
function generateCode(ast2) {
  var compact = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  return escodegen.generate(ast2, compact ? COMPACT_OPTIONS : PRETTY_OPTIONS);
}
__name(generateCode, "generateCode");
function generateObjectCode(ast2) {
  var compact = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  return !compact ? generateCode(ast2) : generateCompactObjectCode(ast2);
}
__name(generateObjectCode, "generateObjectCode");
function generateCompactObjectCode(ast2) {
  var result = generateCode(ast2, true);
  if (!result.endsWith(" }")) {
...
function generateArrayCode(ast2) {
  var compact = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  return !compact ? generateMultilineArrayCode(ast2) : generateCompactArrayCode(ast2);
}
__name(generateArrayCode, "generateArrayCode");
function generateMultilineArrayCode(ast2) {
  var result = generateCode(ast2);
  if (result.endsWith("  }]")) {
...
function generateCompactArrayCode(ast2) {
  var result = generateCode(ast2, true);
...
var isMemo = /* @__PURE__ */ __name(function isMemo2(component) {
  return component.$$typeof === Symbol.for("react.memo");
}, "isMemo");
var isForwardRef = /* @__PURE__ */ __name(function isForwardRef2(component) {
...
Position.prototype.offset = /* @__PURE__ */ __name(function offset(n2) {
  return new Position(this.line, this.column + n2);
}, "offset");
var SourceLocation = /* @__PURE__ */ __name(function SourceLocation2(p2, start, end) {
  this.start = start;
  this.end = end;
...
Parser.prototype.inNonArrowFunction = /* @__PURE__ */ __name(function inNonArrowFunction() {
...
pp$1.parseBreakContinueStatement = function(node, keyword2) {
...
pp$1.parseClassElement = function(constructorAllowsSuper) {
  ...
  var tryContextual = /* @__PURE__ */ __name(function(k2, noLineBreak) {
...
var Token = /* @__PURE__ */ __name(function Token2(p2) {
  this.type = p2.type;
  this.value = p2.value;
  this.start = p2.start;
  this.end = p2.end;
...
__name(parseExpressionAt2, "parseExpressionAt");
...
const jsx = acornJsx.exports;
function simple(node, visitors, baseVisitor, state, override) {
  if (!baseVisitor) {
    baseVisitor = base;
  }
  (/* @__PURE__ */ __name(function c2(node2, st, override2) {
...
var ACORN_WALK_VISITORS = Object.assign({}, base, {
  JSXElement: /* @__PURE__ */ __name(function JSXElement() {
  }, "JSXElement")
});
...
function calculateNodeDepth(node) {
  ...
  ancestor(
    node,
    {
      ObjectExpression: /* @__PURE__ */ __name(function ObjectExpression(_, ancestors) {
        depths.push(filterAncestors(ancestors).length);
      }, "ObjectExpression"),
      ArrayExpression: /* @__PURE__ */ __name(function ArrayExpression(_, ancestors) {
        depths.push(filterAncestors(ancestors).length);
      }, "ArrayExpression")
    },
    ACORN_WALK_VISITORS
...
function parseFunction(funcNode) {
  ...
  simple(
    funcNode.body,
    {
      JSXElement: /* @__PURE__ */ __name(function JSXElement2(node) {
...
function parse3(value) {
  var ast2 = acornParser.parse("(".concat(value, ")"));
  var parsingResult = {
    inferredType: {
...
function createTypeDef(_ref) {
  var name2 = _ref.name, short = _ref.short, compact = _ref.compact, full = _ref.full, inferredType = _ref.inferredType;
  return {
    name: name2,
    short,
    compact,
...
function prettyObject(ast2) {
  var compact = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  return cleanPropTypes(generateObjectCode(ast2, compact));
}
__name(prettyObject, "prettyObject");
function prettyArray(ast2) {
  var compact = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
  return cleanPropTypes(generateCode(ast2, compact));
}
...
function generateTypeFromString(value, originalTypeName) {
  var _inspectValue = inspectValue(value), inferredType = _inspectValue.inferredType, ast2 = _inspectValue.ast;
  ...
  switch (type) {
    ...
    case InspectionType.OBJECT: {
      ...
      compact = depth === 1 ? prettyObject(ast2, true) : null;
      full = prettyObject(ast2);
      break;
    }
    case InspectionType.ELEMENT: {
    ...
    case InspectionType.ARRAY: {
      ...
      short = ARRAY_CAPTION;
      compact = _depth <= 2 ? prettyArray(ast2, true) : null;
      full = prettyArray(ast2);
      break;
    }
    default:
...
function generateFunc$1(extractedProp) {
...
__name(generateFunc$1, "generateFunc$1");
function generateShape(type, extractedProp) {
  ...
  var _inspectValue2 = inspectValue("{ ".concat(fields, " }")), inferredType = _inspectValue2.inferredType, ast2 = _inspectValue2.ast;
  var _ref6 = inferredType, depth = _ref6.depth;
  return createTypeDef({
    name: PropTypesType.SHAPE,
    short: OBJECT_CAPTION,
    compact: depth === 1 && ast2 ? prettyObject(ast2, true) : null,
    full: ast2 ? prettyObject(ast2) : null
  });
}
...
function generateUnion(type, extractedProp) {
  if (Array.isArray(type.value)) {
    var values = type.value.reduce(function(acc, v2) {
      var _generateType2 = generateType(v2, extractedProp), short = _generateType2.short, compact = _generateType2.compact, full = _generateType2.full;
...
function generateEnum(type) {
  if (Array.isArray(type.value)) {
    var values = type.value.reduce(function(acc, v2) {
      var _generateEnumValue = generateEnumValue(v2), short = _generateEnumValue.short, compact = _generateEnumValue.compact, full = _generateEnumValue.full;
      acc.short.push(short);
      acc.compact.push(compact);
      acc.full.push(full);
      return acc;
...
function generateArray$1(type, extractedProp) {
  var _generateType3 = generateType(type.value, extractedProp), name2 = _generateType3.name, short = _generateType3.short, compact = _generateType3.compact, full = _generateType3.full, inferredType = _generateType3.inferredType;
  if (name2 === PropTypesType.CUSTOM) {
    if (inferredType === InspectionType.OBJECT) {
      return createArrayOfObjectTypeDef(short, compact, full);
    }
  } else if (name2 === PropTypesType.SHAPE) {
    return createArrayOfObjectTypeDef(short, compact, full);
  }
  return createTypeDef({
    name: PropTypesType.ARRAYOF,
...
__name(generateArray$1, "generateArray$1");
  ...
  try {
    switch (type.name) {
      ...
      case PropTypesType.FUNC:
        return generateFunc$1(extractedProp);
      ...
      case PropTypesType.ARRAYOF:
        return generateArray$1(type, extractedProp);
      default:
        return createTypeDef({
          name: type.name,
          short: type.name,
...
function generateObject(_ref) {
  var inferredType = _ref.inferredType, ast2 = _ref.ast;
  var _ref2 = inferredType, depth = _ref2.depth;
  if (depth === 1) {
    var compactObject = generateObjectCode(ast2, true);
    if (!isTooLongForDefaultValueSummary(compactObject)) {
      return createSummaryValue(compactObject);
    }
  }
  return createSummaryValue(OBJECT_CAPTION, generateObjectCode(ast2));
}
...
function generateArray(_ref) {
  ...
  var _ref2 = inferredType, depth = _ref2.depth;
  if (depth <= 2) {
    var compactArray = generateArrayCode(ast2, true);
    if (!isTooLongForDefaultValueSummary(compactArray)) {
      return createSummaryValue(compactArray);
    }
  }
  return createSummaryValue(ARRAY_CAPTION, generateArrayCode(ast2));
}
...
function generateFunc(_ref) {
  ...
  if (identifier != null) {
    return createSummaryValue(getPrettyIdentifier(inferredType), generateCode(ast2));
  }
  var prettyCaption = generateCode(ast2, true);
  return !isTooLongForDefaultValueSummary(prettyCaption) ? createSummaryValue(prettyCaption) : createSummaryValue(FUNCTION_CAPTION, generateCode(ast2));
}
...
function _typeof$1(obj) {
  ...
  if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
    _typeof$1 = /* @__PURE__ */ __name(function(obj2) {
      return typeof obj2;
    }, "_typeof$1");
  } else {
    _typeof$1 = /* @__PURE__ */ __name(function(obj2) {
...
function safeSortObject(value, seen2) {
  ...
  if (value instanceof Date || value instanceof RegExp || /* @__PURE__ */ react.exports.isValidElement(value)) {
    return value;
  }
  seen2.add(value);
...
var supportFragment = Boolean(react.exports.Fragment);
...
var getWrappedComponentDisplayName = /* @__PURE__ */ __name(function getWrappedComponentDisplayName2(Component) {
  switch (true) {
    case Boolean(Component.displayName):
      return Component.displayName;
    case Component.$$typeof === reactIs.exports.Memo:
      return getWrappedComponentDisplayName2(Component.type);
    case Component.$$typeof === reactIs.exports.ForwardRef:
...
var getReactElementDisplayName = /* @__PURE__ */ __name(function getReactElementDisplayName2(element) {
  switch (true) {
    ...
    case reactIs.exports.isForwardRef(element):
    case reactIs.exports.isMemo(element):
      return getWrappedComponentDisplayName(element.type);
    case reactIs.exports.isContextConsumer(element):
      return "".concat(element.type._context.displayName || "Context", ".Consumer");
    case reactIs.exports.isContextProvider(element):
      return "".concat(element.type._context.displayName || "Context", ".Provider");
    case reactIs.exports.isLazy(element):
      return "Lazy";
    case reactIs.exports.isProfiler(element):
      return "Profiler";
    case reactIs.exports.isStrictMode(element):
      return "StrictMode";
    case reactIs.exports.isSuspense(element):
      return "Suspense";
    default:
...
var parseReactElement = /* @__PURE__ */ __name(function parseReactElement2(element, options) {
  ...
  if (typeof element === "string") {
    ...
    throw new Error("react-element-to-jsx-string: Expected a React.Element, got `".concat(_typeof$1(element), "`"));
  }
...
var formatComplexDataStructure = /* @__PURE__ */ __name(function(value, inline, lvl, options) {
  ...
  var stringifiedValue = prettyPrint_1(normalizedValue, {
    transform: /* @__PURE__ */ __name(function transform(currentObj, prop, originalResult) {
      ...
      if (currentValue && /* @__PURE__ */ react.exports.isValidElement(currentValue)) {
...
var formatPropValue = /* @__PURE__ */ __name(function formatPropValue2(propValue, inline, lvl, options) {
  ...
  if (/* @__PURE__ */ react.exports.isValidElement(propValue)) {
...
var formatProp = /* @__PURE__ */ __name(function(name2, hasValue, value, hasDefaultValue, defaultValue, inline, lvl, options) {
...
var sortPropsByNames = /* @__PURE__ */ __name(function(shouldSortUserProps) {
  return function(props) {
    ...
    var sortedProps = shouldSortUserProps ? _toConsumableArray$1(userPropsOnly.sort()) : _toConsumableArray$1(userPropsOnly);
    if (haveRefProp) {
...
function extractFunctionName(func, propName) {
  var name2 = func.name;
  if (name2 !== "" && name2 !== "anonymous" && name2 !== propName) {
    return name2;
  }
  return null;
}
__name(extractFunctionName, "extractFunctionName");
var stringResolver = /* @__PURE__ */ __name(function stringResolver2(rawDefaultProp) {
...
var objectResolver = /* @__PURE__ */ __name(function objectResolver2(rawDefaultProp) {
  if (isReactElement(rawDefaultProp) && rawDefaultProp.type != null) {
    return generateReactObject(rawDefaultProp);
  }
  if (isPlainObject_1(rawDefaultProp)) {
...
var functionResolver = /* @__PURE__ */ __name(function functionResolver2(rawDefaultProp, propDef) {
  var isElement = false;
  var inspectionResult;
  if (isFunction_1(rawDefaultProp.render)) {
    isElement = true;
  } else if (rawDefaultProp.prototype != null && isFunction_1(rawDefaultProp.prototype.render)) {
    isElement = true;
  } else {
    var innerElement;
    try {
...
var defaultResolver = /* @__PURE__ */ __name(function defaultResolver2(rawDefaultProp) {
...
function keepOriginalDefinitionOrder(extractedProps, component) {
  var propTypes2 = component.propTypes;
  if (propTypes2 != null) {
    return Object.keys(propTypes2).map(function(x) {
      return extractedProps.find(function(y2) {
        return y2.name === x;
      });
    }).filter(function(x) {
      return x;
...
var funcResolver = /* @__PURE__ */ __name(function funcResolver2(rawDefaultProp, _ref) {
  var name2 = _ref.name, type = _ref.type;
  var isElement = type.summary === "element" || type.summary === "elementType";
  var funcName = extractFunctionName(rawDefaultProp, name2);
  if (funcName != null) {
    if (isElement) {
      return createSummaryValue(getPrettyElementIdentifier(funcName));
    }
...
Object.keys(propTypes.exports).forEach(function(typeName) {
  var type = propTypes.exports[typeName];
...
var extractProps = /* @__PURE__ */ __name(function extractProps2(component) {
  return {
    rows: getPropDefs(component, "props")
  };
}, "extractProps");
var extractArgTypes = /* @__PURE__ */ __name(function extractArgTypes2(component) {
  if (component) {
    var _extractProps = extractProps(component), rows = _extractProps.rows;
    if (rows) {
      return rows.reduce(function(acc, row) {
        var name2 = row.name, description2 = row.description, type = row.type, sbType = row.sbType, defaultSummary = row.defaultValue, jsDocTags = row.jsDocTags, required = row.required;
        acc[name2] = {
          name: name2,
          description: description2,
          type: Object.assign({
...
var renderJsx = /* @__PURE__ */ __name(function renderJsx2(code2, options) {
  ...
  for (var i = 0; i < options.skip; i += 1) {
    ...
    if (React__default.Children.count(renderedJSX) > 1) {
    ...
    if (typeof renderedJSX.props.children === "undefined") {
      ...
      if (typeof renderedJSX.type === "function" && renderedJSX.type.name === "") {
        renderedJSX = /* @__PURE__ */ jsx$1(Type, {
          ...renderedJSX.props
        });
      }
  ...
  var displayNameDefaults = typeof options.displayName === "string" ? {
    showFunctions: true,
    displayName: /* @__PURE__ */ __name(function displayName() {
      return options.displayName;
    }, "displayName")
  } : {
    displayName: /* @__PURE__ */ __name(function displayName(el) {
  ...
  var filterDefaults = {
    filterProps: /* @__PURE__ */ __name(function filterProps3(value, key) {
      return value !== void 0;
    }, "filterProps")
  };
  var opts = Object.assign({}, displayNameDefaults, filterDefaults, options);
  var result = React__default.Children.map(code2, function(c2) {
    var child = typeof c2 === "number" ? c2.toString() : c2;
...
var skipJsxRender = /* @__PURE__ */ __name(function skipJsxRender2(context) {
...
var isMdx = /* @__PURE__ */ __name(function isMdx2(node) {
...
var mdxToJsx = /* @__PURE__ */ __name(function mdxToJsx2(node) {
  if (!isMdx(node))
    return node;
  var _node$props2 = node.props;
  _node$props2.mdxType;
  var originalType = _node$props2.originalType, children = _node$props2.children, rest = _objectWithoutProperties(_node$props2, _excluded);
  var jsxChildren = [];
  if (children) {
    var array = Array.isArray(children) ? children : [children];
    jsxChildren = array.map(mdxToJsx2);
  }
  return /* @__PURE__ */ react.exports.createElement.apply(void 0, [originalType, rest].concat(_toConsumableArray(jsxChildren)));
}, "mdxToJsx");
var jsxDecorator = /* @__PURE__ */ __name(function jsxDecorator2(storyFn, context) {
...
var parameters = {
  docs: {
    inlineStories: true,
    prepareForInline: /* @__PURE__ */ __name(function prepareForInline(storyFn) {
      return storyFn();
    }, "prepareForInline"),
    extractArgTypes,
