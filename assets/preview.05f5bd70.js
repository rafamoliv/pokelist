...
import { w as window_1, l as logger, d as dedent, z as useMemo, u as useEffect, k as browser } from "./iframe.16f10e94.js";
...
var isReduceMotionEnabled = /* @__PURE__ */ __name(function isReduceMotionEnabled2() {
  var prefersReduceMotion = window.matchMedia("(prefers-reduced-motion: reduce)");
  return prefersReduceMotion.matches;
}, "isReduceMotionEnabled");
var getBackgroundColorByName = /* @__PURE__ */ __name(function getBackgroundColorByName2(currentSelectedValue) {
...
var clearStyles = /* @__PURE__ */ __name(function clearStyles2(selector) {
  var selectors = Array.isArray(selector) ? selector : [selector];
  selectors.forEach(clearStyle);
}, "clearStyles");
var clearStyle = /* @__PURE__ */ __name(function clearStyle2(selector) {
  var element = document.getElementById(selector);
  if (element) {
    element.parentElement.removeChild(element);
  }
}, "clearStyle");
var addGridStyle = /* @__PURE__ */ __name(function addGridStyle2(selector, css) {
...
var addBackgroundStyle = /* @__PURE__ */ __name(function addBackgroundStyle2(selector, css, storyId) {
  var existingStyle = document.getElementById(selector);
  if (existingStyle) {
    if (existingStyle.innerHTML !== css) {
      existingStyle.innerHTML = css;
...
var withBackground = /* @__PURE__ */ __name(function withBackground2(StoryFn, context) {
...
var withGrid = /* @__PURE__ */ __name(function withGrid2(StoryFn, context) {
