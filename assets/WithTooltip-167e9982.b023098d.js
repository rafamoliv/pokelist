...
import { I as memoize } from "./iframe.16f10e94.js";
import "./es.map.constructor.edb80200.js";
import { w as window_1, a as __rest, b as _objectWithoutPropertiesLoose, h as _extends, m as modifierPhases, i as auto, s as start, p as placements, j as top, l as left, k as bottom, r as right, n as end, o as popper, v as variationPlacements, q as basePlacements, u as reference, x as viewport, y as clippingParents } from "./index.64c5d0bf.js";
import "./es.regexp.flags.63f8c339.js";
import { r as react, R as React__default, j as jsx } from "./jsx-runtime.1846cd15.js";
import { a as styled, l as lightenColor, d as darkenColor } from "./index.31bee4a5.js";
...
var unwrapArray = /* @__PURE__ */ __name(function unwrapArray2(arg) {
  return Array.isArray(arg) ? arg[0] : arg;
}, "unwrapArray");
var safeInvoke = /* @__PURE__ */ __name(function safeInvoke2(fn2) {
  if (typeof fn2 === "function") {
...
var setRef$1 = /* @__PURE__ */ __name(function setRef(ref, node) {
...
var NOOP_PROMISE = /* @__PURE__ */ __name(function NOOP_PROMISE2() {
...
var TooltipContext = /* @__PURE__ */ React__default.createContext({});
var callAll = /* @__PURE__ */ __name(function callAll2() {
...
var canUseDOM = /* @__PURE__ */ __name(function canUseDOM2() {
  return !!(typeof window !== "undefined" && window.document && window.document.createElement);
}, "canUseDOM");
var setRef2 = /* @__PURE__ */ __name(function setRef3(ref, node) {
  if (typeof ref === "function") {
    return ref(node);
  } else if (ref != null) {
    ref.current = node;
...
var Tooltip$1 = /* @__PURE__ */ function(_Component) {
  ...
  _proto.isTriggeredBy = /* @__PURE__ */ __name(function isTriggeredBy(event) {
...
var TooltipTrigger = /* @__PURE__ */ function(_Component) {
  ...
  function TooltipTrigger2() {
    ...
    _this.setTooltipState = function(state) {
      var cb = /* @__PURE__ */ __name(function cb2() {
  ...
  __name(TooltipTrigger2, "TooltipTrigger");
  ...
  _proto.render = /* @__PURE__ */ __name(function render() {
    ...
    var popper2 = /* @__PURE__ */ React__default.createElement(Popper, _extends({
      ...
      modifiers: [{
        ...
        phase: "main",
        fn: /* @__PURE__ */ __name(function fn2(data) {
    ...
    }), this.getState() && (usePortal ? /* @__PURE__ */ reactDom.exports.createPortal(popper2, portalContainer) : popper2));
  }, "render");
  _proto.isControlled = /* @__PURE__ */ __name(function isControlled() {
    return this.props.tooltipShown !== void 0;
  }, "isControlled");
  _proto.getState = /* @__PURE__ */ __name(function getState() {
...
var Tooltip = /* @__PURE__ */ __name(function Tooltip2(_a) {
...
var WithTooltipPure = /* @__PURE__ */ __name(function WithTooltipPure2(_a) {
  ...
  return React__default.createElement(TooltipTrigger$1, {
    ...
    tooltipShown,
    onVisibilityChange,
    tooltip: /* @__PURE__ */ __name(function tooltip(_ref10) {
...
var WithToolTipState = /* @__PURE__ */ __name(function WithToolTipState2(_a) {
  var startOpen = _a.startOpen, onChange = _a.onVisibilityChange, rest = __rest(_a, ["startOpen", "onVisibilityChange"]);
  var _useState = react.exports.useState(startOpen || false), _useState2 = _slicedToArray(_useState, 2), tooltipShown = _useState2[0], setTooltipShown = _useState2[1];
  var onVisibilityChange = react.exports.useCallback(function(visibility) {
    if (onChange && onChange(visibility) === false)
      return;
    setTooltipShown(visibility);
  }, [onChange]);
  react.exports.useEffect(function() {
    var hide2 = /* @__PURE__ */ __name(function hide3() {
      return onVisibilityChange(false);
    }, "hide");
    ...
    iframes.forEach(function(iframe) {
      var bind = /* @__PURE__ */ __name(function bind2() {
        try {
